        ...
        <>
          <div className="space-y-4">
            ...
            <div>
              ...
              <input type="tel" {...register('phone')} className={inputClasses} placeholder="+91 987 123-4567" />
            </div>
            <div>
        ...
        <>
          <div className="space-y-4">
            ...
            <div>
              ...
              <input type="text" {...register('year')} className={inputClasses} placeholder="2022 - 2026" />
            </div>
            <div>
