              ...
              <FormCard title="Personal Information" icon={FaUser}>
                <div className="space-y-4">
                  <div>
                    ...
                    <input type="text" {...register('name')} className={inputClasses} placeholder="Aman Verma" />
                  </div>
                  <div>
                    <label className={labelClasses}>Email</label>
                    <input type="email" {...register('email')} className={inputClasses} placeholder="XYZ@example.com" />
                  </div>
                  <div>
                    <label className={labelClasses}>Phone</label>
                    <input type="tel" {...register('phone')} className={inputClasses} placeholder="+91 989 123-4567" />
                  </div>
                  <div>
              ...
              <FormCard title="Job Details" icon={FaBriefcase}>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input type="text" {...register('recipientName')} className={inputClasses} placeholder="Mr. Aman verma" />
                  </div>
                  <div>
              ...
              <FormCard title="Additional Information" icon={FaInfoCircle}>
                <div className="space-y-4">
                  <div>
                    ...
                    <input type="text" {...register('industry')} className={inputClasses} placeholder="Technology, IT, Finance" />
                  </div>
                  <div>
